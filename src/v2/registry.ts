...
const v2 = (name: string, category: CommandCategory, permission: Permission = 'public', aliases: string[] = [], args = '', quota: string | null = null): CommandDefinition => ({
  name, aliases, args, category, contexts: ['group', 'private'], permission, cooldownSeconds: 2, quota, cost: 0, implementation: 'v2'
});

export const commandRegistry: CommandDefinition[] = [
  legacy('menu', 'painel', 'public', ['ajuda']), legacy('adm', 'painel', 'admin'), legacy('dono', 'painel', 'owner'), legacy('vip', 'painel'), legacy('menuapi', 'painel'), legacy('rpg', 'painel'), v2('filmes-series', 'painel', 'public', ['filmeseries']), v2('diversao', 'painel', 'public', ['economia']),
  ...
  legacy('renomear', 'nox', 'public', [], 'NovoNome'), legacy('personagem', 'nox'), legacy('habilidades', 'nox'), legacy('inventario', 'nox'), legacy('mapa', 'nox'), legacy('explorar', 'nox'), legacy('viajar', 'nox', 'public', [], 'local'), legacy('missao', 'nox'), legacy('acao', 'nox', 'public', [], 'estratégia'), legacy('evento', 'nox'), legacy('faccoes', 'nox'), legacy('reputacao', 'nox'), legacy('historia', 'nox'), legacy('codex', 'nox'), legacy('rankingrpg', 'nox'),
