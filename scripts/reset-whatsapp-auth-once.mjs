...
const marker = join(authDir, '.wa-auth-reset-v5');
...
if (await exists(marker)) {
  console.log('[WA RESET] Reset V5 já executado anteriormente; pulando.');
  process.exit(0);
}
...
const backupDir = join(backupsDir, `wa-auth-reset-v5-${stamp}`);
...
console.log(`[WA RESET] Auth do WhatsApp resetada (V5): ${removed} arquivos removidos após backup.`);
console.log(`[WA RESET] Backup V5 criado em ${backupDir}.`);
