...
const marker = join(authDir, '.wa-auth-reset-v3');
...
if (await exists(marker)) {
  console.log('[WA RESET] Reset V3 já executado anteriormente; pulando.');
  process.exit(0);
}
...
const backupDir = join(backupsDir, `wa-auth-reset-v3-${stamp}`);
...
console.log(`[WA RESET] Auth do WhatsApp resetada (V3): ${removed} arquivos removidos após backup.`);
