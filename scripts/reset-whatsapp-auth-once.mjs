...
const marker = join(authDir, '.wa-auth-reset-v4');
...
if (await exists(marker)) {
  console.log('[WA RESET] Reset V4 já executado anteriormente; pulando.');
  process.exit(0);
}
...
const backupDir = join(backupsDir, `wa-auth-reset-v4-${stamp}`);
...
console.log(`[WA RESET] Auth do WhatsApp resetada (V4): ${removed} arquivos removidos após backup.`);
